define([
  "./Matrix2-860854d4",
  "./AxisAlignedBoundingBox-ebc959c9",
  "./Transforms-0becfc64",
  "./when-4bbc8319",
  "./RuntimeError-1349fdaf",
  "./TerrainEncoding-f1aea1f9",
  "./ComponentDatatype-8f55628c",
  "./OrientedBoundingBox-07e6723c",
  "./WebMercatorProjection-be9aaee9",
  "./createTaskProcessorWorker",
  "./combine-e9466e32",
  "./AttributeCompression-5f6be9e6",
  "./WebGLConstants-508b9636",
  "./EllipsoidTangentPlane-407b38a6",
  "./IntersectionTests-1d677ce2",
  "./Plane-0e4269ac",
], function (e, t, i, a, n, r, s, l, o, f, u, c, d, h, m, g) {
  "use strict";
  ...
  x.computeVertices = function (n) {
    ...
    const O = a.defaultValue(n.includeWebMercatorT, !1),
      ...
      z = 1 !== R,
      H = a.defaultValue(n.structure, x.DEFAULT_STRUCTURE),
      _ = a.defaultValue(H.heightScale, x.DEFAULT_STRUCTURE.heightScale),
      Y = a.defaultValue(H.heightOffset, x.DEFAULT_STRUCTURE.heightOffset),
      W = a.defaultValue(
        H.elementsPerHeight,
        x.DEFAULT_STRUCTURE.elementsPerHeight
      ),
      X = a.defaultValue(H.stride, x.DEFAULT_STRUCTURE.stride),
      Z = a.defaultValue(
        H.elementMultiplier,
        x.DEFAULT_STRUCTURE.elementMultiplier
      ),
      j = a.defaultValue(H.isBigEndian, x.DEFAULT_STRUCTURE.isBigEndian);
    ...
    const ne = i.Transforms.eastNorthUpToFixedFrame(F, v),
      re = e.Matrix4.inverseTransformation(ne, k);
    let se, le;
    O &&
      ((se = o.WebMercatorProjection.geodeticLatitudeToMercatorAngle(P)),
      (le =
        1 / (o.WebMercatorProjection.geodeticLatitudeToMercatorAngle(C) - se)));
    const oe = y;
    ...
    for (let t = we; t < ke; ++t) {
      ...
      O &&
        (I =
          (o.WebMercatorProjection.geodeticLatitudeToMercatorAngle(a) - se) *
          le);
      for (let t = ye; t < Ie; ++t) {
        let a = t;
        a < 0 && (a = 0), a >= b && (a = b - 1);
        ...
        (q.x = R + D * d),
          (q.y = L + P * d),
          (q.z = H + k * d),
          e.Matrix4.multiplyByPoint(re, q, w),
    ...
    let Te, Me;
    if (
      (a.defined(D) && (Te = l.OrientedBoundingBox.fromRectangle(D, ie, ae, v)),
      N)
    ) {
      Me = new r.EllipsoidalOccluder(
        v
  ...
  var b = a.createCommonjsModule(function (e) {
          ...
          ((t = {
            ...
            decode: function (e, s) {
              var l =
                ...
                f =
                  null !== s.noDataValue ? s.noDataValue : t.defaultNoDataValue,
                u = i(
                  o,
            ...
            decodeBits: function (e, t, i, a, n) {
              ...
              if (w) {
                ...
                (T = Math.ceil((y * B) / 8)),
                  ...
                  (t.ptr += T),
                  (V =
                    s >= 3 ? u(v, k, A - 1, a, D, S) : o(v, k, A - 1, a, D, S)),
                  ...
                  for (
                    ...
                    if (2 !== p)
                      if (0 === p) {
                        ...
                        ((t.ptr += C), h.decodeBits(e, t, F, w, k), (C = 0), L)
                      )
                        for (y = 0; y < T; y++) {
